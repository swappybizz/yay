        ...
        <div className="container mx-auto flex px-5 py-24 items-center justify-center flex-col">
          <div className="text-center lg:w-2/3 w-full">
            ...
            <div className="flex justify-center ">
              <button className="mt-12 inline-flex  text-black bg-white font-admitText outline-black outline-2 py-2 px-6 focus:outline-none hover:bg-gray-200 hover:outline-none  rounded-full text-lg">
