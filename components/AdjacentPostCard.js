...
const AdjacentPostCard = ({ post, position }) => (
  <>
    ...
    {position === 'LEFT' && (
      <div className="absolute arrow-btn bottom-5 text-center py-3 cursor-pointer bg-transparent left-4 rounded-full">
    ...
    {position === 'RIGHT' && (
      <div className="absolute arrow-btn bottom-5 text-center py-3 cursor-pointer bg-transparent bg-admit-red right-4 rounded-full">
        <svg xmlns="http://www.w3.org/2000/svg" className="h-6 text-white w-full" fill="none" viewBox="0 0 24 24" stroke="rgb(255 89 90)">
