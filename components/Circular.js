        ...
        <section className="text-gray-600 body-font">
          <div className="flex px-5 py-24 justify-center">
            <div className="flex flex-wrap -m-4">
              ...
              >
                <a href="/strategy" className=" flex mx-5 w-36 h-36 border-admit-blue border-2 rounded-full justify-center text-center items-center my-auto py-auto">
              ...
              >
                <a href="/systems" className=" flex mx-5 w-36 h-36 border-admit-blue border-2 rounded-full justify-center text-center items-center my-auto py-auto">
              ...
              >
                <a href="/digital" className=" flex mx-5 w-36 h-36 border-admit-blue border-2 rounded-full justify-center text-center items-center my-auto py-auto">
              ...
              >
                <a href="/economy" className=" flex mx-5 w-36 h-36 border-admit-blue border-2 rounded-full justify-center text-center items-center my-auto py-auto">
              ...
              >
                <a href="/marketing" className=" flex mx-5 w-36 h-36 border-admit-blue border-2 rounded-full justify-center text-center items-center my-auto py-auto">
              ...
              <div className="flex justify-center -mx-4 -mb-10 text-center">
                <div className="sm:w-1/2 mb-10 px-4">
                  <h2 className="title-font text-xl text-gray-900 mt-6 mb-3">
                    Om du er klar for endring, men usikker på hvor du bør starte
                    for å nå dine mål; Bestill tid her for en utforpliktende
                    kartleggings-prat,
                  </h2>
