    ...
    <>
      <section className="text-gray-600 body-font relative font-heroSubText text-xl">
        <div className="container px-5 py-0 mx-auto flex sm:flex-nowrap flex-wrap">
          <div className="lg:w-full w-full md:w-full h-[70vh] bg-gray-300 rounded-lg overflow-hidden sm:mr-10 p-10 flex items-end justify-start relative">
            <iframe
              width="100%"
              height="100%"
      ...
      <div className="bg-white relative flex flex-wrap py-6 md:px-28 rounded shadow-md">
              ...
              <div className="lg:w-1/2 px-6 mt-4 lg:mt-0 ">
                <div className="w-fit animate-pulse rounded ">

                
                <h2 
                title="Skrive E-Post"
                className="title-font  font-semibold font-admitTitle text-gray-900 tracking-widest text-s">
                  E-POST
                </h2>
                <button 
                title="Skrive E-Post"
